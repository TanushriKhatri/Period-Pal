...
+ "Invalid date. Please enter a valid date not in the future or before your last period."+ "\u001B[0m");
} else {
validDate = true;
}
...
System.out.println("\u001B[91m" + "Invalid date. Please enter a valid date not in the future or before our last period."+ "\u001B[0m");
} else {
validDatelpd = true;
}
} catch (DateTimeException e) {
...
myths.add("Myth: Caffeine causes dehydration. Fact: Caffeine has a mild diuretic effect, but it also stimulates the production of urine.");
myths.add("Myth: Eating ice cream makes you catch a cold. Fact: Ice cream doesn't cause colds.");
myths.add("Myth: Eating spicy food causes heartburn. Fact: Spicy food can cause heartburn, but it's not the spiciness that causes it.");
}
...
msgs_sad.add("It’s okay to feel low, %s. Take a deep breath, grab your favorite snack, and know that you’re not alone.💛 ");
...
msgs_demotivated.add("You’ve overcome tough days before, and you will again, %s! One small step today is enough. 💪✨");
...
msgs_nervous.add( "Close your eyes, breathe in peace, breathe out tension. You are stronger than your worries, %s!💪✨💛 "); 
...
msgs_angry.add("Your feelings are valid. Let’s pause, breathe slowly, and let the storm pass— you’ve got this,%s! 🌿");
...
void displaymsg() {
System.out.println("\u001B[94;1m" + "How are you feeling today, " + phase.name + "? Please select an option below:" + "\u001B[0m");
...
case 1:
System.out.println("\u001B[92m"+ "You are experiencing cramps. Consider using a heating pad for relief." + "\u001B[0m");
symptomLog = "Cramps";
break;
case 2:
...
break;
case 3:
System.out.println("\u001B[92m" + "Mood swings are common. Take some time for self-care." + "\u001B[0m");
symptomLog = "Mood Swings";
break;
case 4:
System.out.println("\u001B[92m" + "Fatigue is normal during this time. Ensure you get enough rest."+ "\u001B[0m");
symptomLog = "Fatigue";
break;
case 5:
System.out.println("\u001B[92m" + "Headaches can be alleviated with hydration and rest." + "\u001B[0m");
symptomLog = "Headaches";
break;
case 6:
System.out.println("\u001B[92m" + "Nausea can be tough. Ginger tea may help settle your stomach." + "\u001B[0m");
symptomLog = "Nausea";
...
FileWriter("symptoms_log.txt", true))) {
